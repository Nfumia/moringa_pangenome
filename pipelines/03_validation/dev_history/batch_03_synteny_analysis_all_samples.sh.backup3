...
for SAMPLE in "${SAMPLES[@]}"; do
    ...
    ALIGNED=$(awk '{sum+=$11} END {printf "%.1f", sum/1000000}' "$SAMPLE_DIR/hap1_vs_hap2.paf")
...
echo "======================================================================="
echo ""
echo ">90% aligned  = High synteny → Mostly collapsed regions"
echo "80-90% aligned = Good synteny → Mixed (collapsed + SVs)"
echo "<80% aligned  = Lower synteny → Significant structural variants"
